...
function MobileWhyKorzi() {
  const whyCards = [
    {
      icon: '../../../public/assets/Product/bis_certified.png',
      title: 'BIS Certified',
      desc: "India's child safety standard. Built for real use",
    },
    {
      icon: '../../../public/assets/Product/indian_flag.png',
      title: 'Made in India',
      desc: 'Built in Bangalore. No customs. Fast delivery.',
    },
    {
      icon: '../../../public/assets/Product/spare_parts.png',
      title: 'Spare Parts',
      desc: 'Toot gaya? Koi tension nahi. Service available.',
    },
    {
      icon: '../../../public/assets/Product/easy_returns.png',
      title: 'Easy Returns',
      ...
      <div className="border border-zinc-800 bg-zinc-950 p-3 flex items-start gap-4">
        ...
        <div className="border-l border-zinc-800 pl-4">
          ...
          <div className="flex items-center gap-1.5 mt-1.5">
            ...
            <img
                  src={'../../../public/assets/Product/verified.png'}
                  alt={'card.title'}
      ...
      <div className="flex items-center justify-center gap-1.5 py-1.5 bg- border-b border-zinc-800">
        ...
        {[timeLeft.m, timeLeft.s].map((val, i) => (
          <span key={i} className="flex items-center gap-0.5">
            <span
              className="bg-[#02FF00] text-black text-[10px] font-bold px-1 py-0.5 font-mono"
