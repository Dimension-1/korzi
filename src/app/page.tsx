...
export default function ComingSoonPage() {
  ...
  return (
    <div className="h-auto bg-black text-white relative overflow-hidden p-4 lg:p-20 pb-0">
      ...
      <div className="hidden lg:block">
        ...
        <div className="flex flex-col justify-center pt-60 px-12">
          ...
          <div className="flex gap-6 items-center flex-wrap">
            ...
            <button className="border-2 border-white px-12 py-6 text-xl font-medium hover:bg-white hover:text-black transition-all duration-300 body-font tracking-wide rounded-none">
              Grip. Guts. Glory
            </button>

            {/* Arrow Button with Text */}
            <button className="border-2 border-white px-8 py-6 text-xl font-medium hover:bg-white hover:text-black transition-all duration-300 flex items-center gap-4 body-font rounded-none bg-white text-black">
      ...
      <div className="lg:hidden flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center px-4 sm:px-8 py-8">
          ...
          <div className="mb-8 text-center">
            <h2 className="leading-tight mb-6 body-font">
              <span className="text-[#02FF00] block text-4xl sm:text-5xl md:text-6xl mb-2">Machines</span>
              <span className="text-white block text-3xl sm:text-4xl md:text-5xl">
                For The <span className="relative">Young
                  <div className="absolute bottom-1 left-0 w-full h-1 bg-white"></div>
                </span>
              </span>
            </h2>
          </div>
        ...
        <div className="flex justify-center py-6">
          ...
          <div className="flex flex-col gap-4 items-center">
            {/* Grip. Guts. Glory Button */}
            <button className="border-2 border-white px-6 py-4 sm:px-8 sm:py-5 text-lg sm:text-xl font-medium hover:bg-white hover:text-black transition-all duration-300 body-font tracking-wide w-full max-w-sm rounded-none">
              Grip. Guts. Glory
            </button>

            {/* Arrow Button with Text */}
            <button className="border-2 border-white px-6 py-4 sm:px-8 sm:py-5 text-lg sm:text-xl font-medium hover:bg-white hover:text-black transition-all duration-300 flex items-center justify-center gap-3 body-font w-full max-w-sm rounded-none bg-white text-black">
