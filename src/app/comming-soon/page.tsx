        ...
        <div className="flex flex-col justify-center pt-60 px-12">
          ...
          <div className="mb-4">
              <h2 className="leading-tight mb-6 body-font">
                <span className="text-[var(--neon-green)] block text-8xl mb-2">Machines</span>
                <span className="block text-5xl md:text-8xl font-black text-foreground mt-4 animate-in fade-in duration-1000 delay-300">
      ...
      <div className="lg:hidden flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center p-4 sm:p-8">
          ...
          <div className="mb-8 text-center">
            <h2 className="leading-tight mb-6 body-font">
              <span className="text-[var(--neon-green)] block text-4xl sm:text-5xl md:text-6xl mb-2" >Machines</span>
              <span className="block text-5xl md:text-8xl font-black text-foreground mt-4 animate-in fade-in duration-1000 delay-300">
